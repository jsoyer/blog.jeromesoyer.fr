...
In the meantime, I pay my bills, optimize my tokens with RTK, and check my iPhone — Moshi for CLI approvals, Grok Bot for the morning watch, the Claude app for questions no Bot deserves.
