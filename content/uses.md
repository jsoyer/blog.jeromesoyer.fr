...
- **[Raycast](https://www.raycast.com/)** — app launcher + extensions (including my [Kitty extension](https://github.com/jsoyer))
...
- One bootstrap command to go from zero to productive
...
- **[mise](https://mise.jdx.dev/)** (formerly rtx) — runtime version manager (replaces nvm, rbenv, pyenv)
